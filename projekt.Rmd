...
Od razvite države lahko pričakujemo, da velik delež dohodka državljanov namenijo zdravljenju. Spodnji graf prikazuje Odstotek dohodka za različne vrste izdatkov v Sloveniji od leta 2005 do leta 2014. Vidimo lahko, da za bolezen namenijo državljani povprečno 30% dohodka na državljana, medtem ko gre večina dohodka (okoli 40%) za starost.

```{r graf.izdatki, echo=FALSE, message=FALSE, fig.align='center'}
print(graf.izdatki)
```

Zadnja kategorija, ki se lahko preveri pri kvaliteti življenja, je število zdravih let. Iz grafa vidimo, da je število le-teh upadlo, medtem ko se povprečna življenjska doba ni spremenila. Vzrok za padec ???
